...
export function SavedForLater({ items, onMoveToBag, onRemove, className }: SavedForLaterProps) {
  ...
  return (
    <section
      ...
      className={cn(
        'mt-8 pt-6 border-t border-border bg-muted/40 rounded-md p-4 sm:p-5',
        className
      )}
    >
          ...
          return (
            ...
            >
              <div className="flex items-center gap-3 min-w-0">
                <div className="relative w-12 h-15 aspect-[4/5] shrink-0 overflow-hidden rounded-md border border-border bg-card">
                ...
                <div className="min-w-0">
                  <Link
                    ...
                    className="block text-sm font-medium text-foreground hover:text-primary transition-colors line-clamp-1"
                  >
                    {item.productTitle}
                  </Link>
                  {item.variantTitle && (
                  ...
                  <div className="font-mono tabular-nums text-xs font-semibold text-foreground mt-0.5">
                    {formattedPrice}
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2 shrink-0">
                ...
                <button
                  ...
                  className="p-2 text-muted-foreground hover:text-destructive transition-colors rounded-sm min-h-[44px] min-w-[44px] flex items-center justify-center sm:min-h-0 sm:min-w-0"
                >
